...
<div class="container">
    <?php
    session_start();
    echo "<h1 class='text-info'>Hello, </h1>" . $_SESSION['username'] . "<h1 class='text-info'>!</h1>";
    ?>
    <br>
    <br>
    <div class="row">
        ...
        <div class="col-4">
            ...
            <a class="btn btn-primary border border-primary bg-primary" href="#" role="button">Trivia</a>
                </div>
            </div>
        </div>
        <div class="col-4">
